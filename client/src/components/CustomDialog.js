...
import { Dialog, DialogTitle, List, ListItem, DialogContent, 
    ListItemIcon, ListItemText, DialogActions, Typography, Collapse, IconButton, Button  } from '@material-ui/core';
...
export default function CustomDialog(props) {
    const { open, selectedTile, onClose, handleClose, addToCart,
        toggleLike, classes, descriptionOpen, color} = props;
